...
@Entity(tableName = DatabaseConfig.MovieColumns.TABLENAME)
public class Movie implements Parcelable {


    //every field that's stored in database table needs to either be public
    //or have a getter and setter
